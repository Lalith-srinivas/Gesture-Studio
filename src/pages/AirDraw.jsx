...
export default function AirDraw() {
  ...
  return (
    <div className="w-full h-full flex flex-col bg-[#FFFDF5] text-black overflow-hidden absolute inset-0 font-sans selection:bg-neo-yellow">
      ...
      {/* ── Main Workspace: Canvas (Left/Center) + Sidebar Toolbar (Right on desktop, Bottom on mobile) ── */}
      <div className="flex-1 flex flex-col md:flex-row overflow-hidden relative">

        {/* ── Canvas Viewport ────────────────────────────────────────────── */}
        <main className="flex-1 relative flex items-center justify-center bg-black overflow-hidden border-b-3 md:border-b-0 md:border-r-3 border-black">
        ...
        {/* ── Toolbar Sidebar (Right on desktop, Bottom on mobile) ─────────── */}
        <aside className="flex-shrink-0 w-full md:w-64 lg:w-72 md:h-full bg-[#FFFDF5] p-3 sm:p-4 overflow-y-auto z-20 shadow-neo md:shadow-none">
          <Toolbar
            strokeColor={strokeColor}
